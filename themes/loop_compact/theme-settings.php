 ...
 *   The form state.
 */
function loop_compact_form_system_theme_settings_alter(&$form, &$form_state) {
  $form['theme_settings']['show_breadcrumbs'] = array(
    '#type' => 'checkbox',
    '#title' => t('Show breadcrumbs'),
    '#default_value' => theme_get_setting('show_breadcrumbs', 'loop_compact'),
  ...
  $form['logout_settings']['show_logout_for_regular_users'] = array(
    ...
    '#default_value' => theme_get_setting('show_logout_for_regular_users', 'loop_compact'),
  ...
  $form['logout_settings']['show_logout_for_saml_users'] = array(
    ...
    '#default_value' => theme_get_setting('show_logout_for_saml_users', 'loop_compact'),
